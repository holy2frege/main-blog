...
ps: 내가 천재같다고 하는건, 하늘에서 뚝 떨어져서 신화에서나 보는
사람이 알아듣기 힘든 언어로 말하는 사람이 아니다. 그런 사람은 천재가
아니다. 나는 신화를 쓰는 사람도 우상화 하는 사람도 아니다. 나도 어느
정도 똑똑하다고 생각하기 때문에 타인의 평가에 냉정하다. 여튼, 내가
말하는 천재는 뭘해도 1등을 할 수 있는 사람을 의미한다. 즉 운동을
시켜도 1등하고 공부를 시켜도 1등하고 음악, 미술을 시켜도 1등하는
사람을 말한다. 이렇게 할려면 gifted된 능력도 있어야하지만, 물론 없어도
된다. 노력으로 극복하면 된다. 예를 들면 안철수 같은 사람이다. 나는
중간이다. 어떤일을 맡겨도 중간은 한다. 처음 하는일이라도 중간은 한다.
...
때문이다. xcode는 설치되어 있지만, apple에서 지원하지 않는다. app을
